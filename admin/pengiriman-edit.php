                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="pengiriman_proses_edit" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Edit</strong> Penerimaan</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="id_pengiriman" readonly class="form-control"
                                                        value="<?php echo $matakuliah["id_pengiriman"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div>   
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="id_penerima" id="id_penerima">
                                                        <option value="<?php echo $matakuliah["id_penerima"]; ?>">
                                                        <?php echo $matakuliah["nama_petugas"]; ?></option>
                                                        <?php
include "../koneksi.php"; 
//display values in combobox/dropdown
$result = mysqli_query($konek,"SELECT * FROM daftar_penerima");
  while($row = mysqli_fetch_assoc($result)){
     echo "<option value=$row[id_penerima]>$row[nama_penerima]</option>";
    } 
?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="id_petugas" id="id_petugas">
                                                        <option value="<?php echo $matakuliah["id_petugas"]; ?>">
                                                            <?php echo $matakuliah["nama_petugas"]; ?></option>
                                                        <?php
include "../koneksi.php"; 
//display values in combobox/dropdown
...
?>
                                            ...
                                            <div class="form-group">                                        
                                                <label class="col-md-3 control-label">tanggal_penerimaan</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        <input type="text" class="form-control datepicker" name="tanggal_pengiriman"
                                                        value="<?php echo $matakuliah["tanggal_pengiriman"]; ?>">                                            
                                                    </div>
                                            ...
                                            <div class="form-group" hidden>
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="id_status" id="id_status">
                                                        <option value="<?php echo $matakuliah["id_status"]; ?>">
                                                        <?php echo $matakuliah["status"]; ?></option>
                                                        <?php
include "../koneksi.php"; 
//display values in combobox/dropdown
$result = mysqli_query($konek,"SELECT * FROM status_penerimaan");
  while($row = mysqli_fetch_assoc($result)){
