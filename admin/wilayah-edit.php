                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="wilayah_proses_edit" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Edit</strong> Wilayah</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"> 
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">id_wilayah</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="id_wilayah" readonly class="form-control"
                                                        value="<?php echo $matakuliah["id_wilayah"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div>   

                                            <div class="form-group">
                                                <label class="col-md-3 control-label">nama_wilayah</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="nama_wilayah" class="form-control"
                                                        value="<?php echo $matakuliah["nama_wilayah"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        value="<?php echo $matakuliah["keterangan"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div>
