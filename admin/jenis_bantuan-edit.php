                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="jenis_bantuan_proses_edit" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Edit</strong> Jenis Bantuan</h3>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="id_bantuan" readonly class="form-control"
                                                        value="<?php echo $matakuliah["id_bantuan"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div>   

                                            <div class="form-group">
                                                <label class="col-md-3 control-label">nama_bantuan</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="nama_bantuan" class="form-control"
                                                        value="<?php echo $matakuliah["nama_bantuan"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        value="<?php echo $matakuliah["deskripsi"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div>
