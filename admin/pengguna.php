        ...
        <div class="page-container">
            ...
            <div class="page-content">
               ...
               <!-- START X-NAVIGATION VERTICAL -->
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>                    
                    <li class="active">Pengguna</a></li>
                </ul>
                <!-- END BREADCRUMB -->

                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Pengguna</h2>
                </div>
                <!-- END PAGE TITLE -->                
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Pengguna</h3><br>
                                ...
                                <a href="pengguna-add"><button class="btn btn-info"><i class="fa fa-plus"></i>Tambah Data</button> </a>
...
<?php
                        $querymatakuliah = mysqli_query ($konek, "SELECT * FROM pengguna");
                        ...
                        while($matakuliah = mysqli_fetch_array($querymatakuliah)){
                            ...
                            echo "
                                ...
                                <tr>
                                    <td>$no</td>
                                    <td>$matakuliah[nama_pengguna]</td>
                                    <td>$matakuliah[username]</td>
                                    <td>$matakuliah[password]</td>
                                    <td>$matakuliah[role]</td>
                                    <td>";
                         
                                if($matakuliah["id_pengguna"]==$_SESSION["id_pengguna"]){
                                    echo "
                                        <a href='#' class='btn btn-primary'><span class='fa fa-times'></span></a> ";
                                }else{
                                    ?>
                                        <a href='pengguna-delete.php?id_pengguna=<?php echo "$matakuliah[id_pengguna]"; ?>'>
