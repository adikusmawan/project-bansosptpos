        ...
        <div class="page-container">
            ...
            <div class="page-content">
              ...
              ?>
                                    ...
                                    <div class="widget-subtitle">Jumlah pengguna</div>
                                </div>      
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-default widget-item-icon" onclick="location.href='#';">
                                ...
                                <div class="widget-data">
                                    <div class="widget-int num-count">
                                    <?php
                $sql = "SELECT * FROM daftar_penerima";
                $query = $konek->query($sql);

                echo "".$query->num_rows."";
              ?>
                                    </div>
                                    <div class="widget-title">Daftar Penerima</div>
                                    <div class="widget-subtitle">Jumlah Daftar Penerima</div>
                                </div>      
                                <div class="widget-controls">                                
                                    <a href="#" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="Remove Widget"><span class="fa fa-times"></span></a>
                                </div>
              ...
              ?>
                                    ...
                                    <div class="widget-title">Penerimaan</div>
                                    <div class="widget-subtitle">Jumlah Penerimaan</div>
                                </div>      
                                <div class="widget-controls">                                
                                    <a href="#" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="Remove Widget"><span class="fa fa-times"></span></a>
                                </div>
              ...
              ?>
                                    ...
                                    <div class="widget-title">Rekapan</div>
                                    <div class="widget-subtitle">Jumlah Rekapan</div>
                                </div>
                                <div class="widget-controls">                                
                                    <a href="#" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="Remove Widget"><span class="fa fa-times"></span></a>
                                </div>                            
