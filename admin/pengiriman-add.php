                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="pengiriman-aksi" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Tambah</strong> Penerimaan</h3>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="id_penerima" id="id_penerima">
                                                        <option hidden>Pilih Penerima</option>
                                                        <?php
include "../koneksi.php"; 
...
?>
                                            ...
                                            <div class="form-group">                                        
                                                <label class="col-md-3 control-label">tanggal_pengiriman</label>
                                                <div class="col-md-9">
                                            ...
                                            <div class="form-group" hidden>                                        
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        <input type="text" class="form-control" name="id_status" value="1">                                            
                                                    </div>
                                                    <span class="help-block">Click on input field to get datepicker</span>
                                                </div>
                                            </div> 
