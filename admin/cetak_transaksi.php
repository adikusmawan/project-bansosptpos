...
if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                ...
                $query = mysqli_query($konek, "SELECT * FROM transaksi
                ...
                <?php 
                echo '
                <h5 class="tgh" id="nama">LAPORAN DATA REKAPAN<br></h5><br/>';
                            ...
                            <p class="tgh"><span class="alamat"> Laporan Data Daftar Transaksi dari Tanggal <strong>'.$d." ".$nm." ".$y.'</strong> sampai dengan tanggal <strong>'.$d2." ".$nm2." ".$y2.'</strong></span></p>
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                 ...
                                 <tr>
                                        ...
                                        <td>'.$row['id_pengiriman'].' - '.$row['nama_penerima'].'</td> 
