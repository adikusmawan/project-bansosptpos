...
if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                ...
                $query = mysqli_query($konek, "SELECT * FROM daftar_penerima 
                            INNER JOIN wilayah ON wilayah.id_wilayah = daftar_penerima.id_wilayah 
                            WHERE tanggal_daftar_penerima BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");

                ?>
                <?php 
                echo '
                <h5 class="tgh" id="nama">LAPORAN DATA DAFTAR PENERIMA<br></h5><br/>';
                            ...
                            <p class="tgh"><span class="alamat"> Laporan Data Daftar Penerima dari Tanggal <strong>'.$d." ".$nm." ".$y.'</strong> sampai dengan tanggal <strong>'.$d2." ".$nm2." ".$y2.'</strong></span></p>
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                 ...
                                 <tr>
                                        ...
                                        <td>'.$row['tanggal_daftar_penerima'].'</td> 
                                </tr> 
                            ';
                                }
                            } else {
                                echo '<tr><td colspan="7"><center><p class="add">Tidak ada data</p></center></td></tr>';
                            } echo '
                        </tbody>
                </table>
            </div>
